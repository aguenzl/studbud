...
let [flowSeconds, flowMinutes, flowHours] = [
    0,
    0,
    0
];
...
let [interruptSeconds, interruptMinutes, interruptHours] = [
    0,
    0,
    0
];
...
let [totalBreakHours, totalBreakMinutes, totalBreakSeconds] = [
    0,
    0,
    0
];
let [totalInterruptHours, totalInterruptMinutes, totalInterruptSeconds] = [
    0,
    0,
    0
];
...
document.getElementById('controlFlow').addEventListener('click', ()=>{
    ...
    // The colour is that dark blue colour and the other two buttons are hidden. 
        ...
        [flowSeconds, flowMinutes, flowHours] = [
            0,
            0,
            0
        ];
        [totalBreakHours, totalBreakMinutes, totalBreakSeconds] = [
            0,
            0,
            0
        ];
        [totalInterruptHours, totalInterruptMinutes, totalInterruptSeconds] = [
            0,
            0,
            0
        ];
...
document.getElementById('breakFlow').addEventListener('click', ()=>{
    ...
    // back to orange.
        ...
        [breakSeconds, breakMinutes, breakHours] = [
            0,
            0,
            0
        ];
...
document.getElementById('interruptFlow').addEventListener('click', ()=>{
    ...
    // back to red.
        ...
        [interruptSeconds, interruptMinutes, interruptHours] = [
            0,
            0,
            0
        ];
