...
function createTodo() {
    ...
    /* ARIELLA: extra fields in here like the line above */ const txt = document.createTextNode("Title: , Author: " + input_author_val + input_title_val + ", Text Type: " + input_texttype_val);
